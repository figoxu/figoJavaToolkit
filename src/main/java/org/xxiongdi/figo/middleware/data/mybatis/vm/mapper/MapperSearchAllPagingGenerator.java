 ...
 *
 */
public class MapperSearchAllPagingGenerator extends BaseMapperGenerator {
    public static String getDefaultSqlName(Class clazz){
        String sqlName = "search"+clazz.getSimpleName()+"AllPaging";
        return sqlName;
    }
    ...
    public static String gensql(Class clazz) throws Exception {
        String template = "/org/xxiongdi/figo/middleware/data/mybatis/vm/mapper/mapper_search_all_paging.vm";
